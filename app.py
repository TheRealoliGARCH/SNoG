...
with tab1:
    ...
    if st.button("🚀 CLASSIFY THIS CRISIS NOW", type="primary", use_container_width=True):
        ...
        fig = go.Figure()
        fig.add_trace(go.Bar(x=[f"D{i+1}" for i in range(9)], y=z_scores, marker_color="#00D4FF",
                             text=[f"{z:.2f}" for z in z_scores], textposition="auto"))
...
with tab5:
    ...
    historical_crises = {
        "2008 Global Financial Crisis (Lehman Collapse)": {"loss": 38000, "imp_level": 0.0, "I_k": 1.85, "desc": "Subprime meltdown & systemic banking collapse"},
        "2020 COVID-19 Market Crash (March)": {"loss": 29500, "imp_level": 0.2, "I_k": 1.75, "desc": "Global liquidity panic and flash crash"},
        "1997 Asian Financial Crisis": {"loss": 21800, "imp_level": 0.0, "I_k": 1.92, "desc": "Currency devaluations & capital flight across Asia"},
        "2022 Inflation & Rate-Hike Shock": {"loss": 16500, "imp_level": 0.4, "I_k": 1.65, "desc": "Central-bank tightening & bond-market turmoil"},
        "Hypothetical 2025 Quantum Impersonation Cyber Attack": {"loss": 24200, "imp_level": 1.0, "I_k": 1.78, "desc": "Advanced persistent threat targeting oliGARCH command nodes"}
    }
